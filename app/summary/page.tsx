...
export default function Summary() {
  return (
    <div>
            ...
            <div className='md:h-full max-w-full mx-5 px-4 md:px-auto flex flex-col'>
                ...
                <div className='grid md:grid-cols-[1.5fr_8.5fr_3.15fr] gap-4 mt-10 mb-40 md:gap-4 pb-0 md:pb-0 md:mb-0'>
                    ...
                    <div className='relative bg-gray-100 p-4 flex flex-col items-center justify-center md:h-[57vh] md:border-t'>
                        <p className="hidden md:block md:absolute text-[40px] mb-2 left-5 top-2">South asian</p>
      ...
      a 49.15,49.15 0 1 1 0,-98.3
    " strokeWidth="1.7" fillOpacity="0" style={{strokeLinecap: "butt", strokeDasharray: "308.819px, 308.819px", strokeDashoffset: "0px;"}}></path><path className="CircularProgressbar-path" d="
      M 50,50
      m 0,-49.15
      a 49.15,49.15 0 1 1 0,98.3
      a 49.15,49.15 0 1 1 0,-98.3
    " strokeWidth="1.7" fillOpacity="0" style={{stroke: 'rgb(26, 27, 28)', strokeLinecap: 'butt', transitionDuration: '0.8s', strokeDasharray: '308.819px, 308.819px', strokeDashoffset: '154.409px'}}></path></svg>
                             <div className='absolute inset-0 flex items-center justify-center'>
                                <p className="text-3xl md:text-[40px] font-normal">50<span className="absolute text-xl md:text-3xl">%</span></p>
                             </div>
                                 </div>
                        </div>
                    ...
                    <div className='bg-gray-100 pt-4 pb-4 md:border-t'>
                        <div className='space-y-0'>
                            ...
                            <div className="flex items-center justify-between h-[48px] hover:bg-[#E1E1E2] px-4 cursor-pointer bg-[#1A1B1C] text-white hover:bg-black"><div className="flex items-center gap-1">
                                <img alt="radio button" loading="lazy" width="12" height="12" decoding="async" data-nimg="1" className="w-[12px] h-[12px] mr-2" src="/radio-button.png" style={{color: 'transparent'}}/>
                                <span className="font-normal text-base leading-6 tracking-tight">South asian</span></div><span className="font-normal text-base leading-6 tracking-tight">50%</span></div>
                                <div className="flex items-center justify-between h-[48px] hover:bg-[#E1E1E2] px-4 cursor-pointer "><div className="flex items-center gap-1"><img alt="radio button" loading="lazy" width="12" height="12" decoding="async" data-nimg="1" className="w-[12px] h-[12px] mr-2" src="/radio-button.png" style={{color: 'transparent'}}/><span className="font-normal text-base leading-6 tracking-tight">White</span></div><span className="font-normal text-base leading-6 tracking-tight">46%</span></div>
                                <div className="flex items-center justify-between h-[48px] hover:bg-[#E1E1E2] px-4 cursor-pointer "><div className="flex items-center gap-1"><img alt="radio button" loading="lazy" width="12" height="12" decoding="async" data-nimg="1" className="w-[12px] h-[12px] mr-2" src="/radio-button.png" style={{color: 'transparent'}}/><span className="font-normal text-base leading-6 tracking-tight">Black</span></div><span className="font-normal text-base leading-6 tracking-tight">1%</span></div>
                                <div className="flex items-center justify-between h-[48px] hover:bg-[#E1E1E2] px-4 cursor-pointer "><div className="flex items-center gap-1"><img alt="radio button" loading="lazy" width="12" height="12" decoding="async" data-nimg="1" className="w-[12px] h-[12px] mr-2"  src="/radio-button.png" style={{color: 'transparent'}}/><span className="font-normal text-base leading-6 tracking-tight">Southeast asian</span></div><span className="font-normal text-base leading-6 tracking-tight">0%</span></div>
                                <div className="flex items-center justify-between h-[48px] hover:bg-[#E1E1E2] px-4 cursor-pointer "><div className="flex items-center gap-1"><img alt="radio button" loading="lazy" width="12" height="12" decoding="async" data-nimg="1" className="w-[12px] h-[12px] mr-2" src="/radio-button.png" style={{color: 'transparent'}}/><span className="font-normal text-base leading-6 tracking-tight">Latino hispanic</span></div><span className="font-normal text-base leading-6 tracking-tight">0%</span></div>
                                <div className="flex items-center justify-between h-[48px] hover:bg-[#E1E1E2] px-4 cursor-pointer "><div className="flex items-center gap-1"><img alt="radio button" loading="lazy" width="12" height="12" decoding="async" data-nimg="1" className="w-[12px] h-[12px] mr-2"   src="/radio-button.png" style={{color: 'transparent'}}/><span className="font-normal text-base leading-6 tracking-tight">East asian</span></div><span className="font-normal text-base leading-6 tracking-tight">0%</span></div>
                                <div className="flex items-center justify-between h-[48px] hover:bg-[#E1E1E2] px-4 cursor-pointer "><div className="flex items-center gap-1"><img alt="radio button" loading="lazy" width="12" height="12" decoding="async" data-nimg="1" className="w-[12px] h-[12px] mr-2"  src="/radio-button.png" style={{color: 'transparent'}}/><span className="font-normal text-base leading-6 tracking-tight">Middle eastern</span></div><span className="font-normal text-base leading-6 tracking-tight">0%</span></div>
                        </div>
                        </div>
                    </div>
