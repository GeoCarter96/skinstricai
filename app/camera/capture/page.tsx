        ...
        <div className='relative h-[92vh] w-screen overflow-hidden bg-gray-900'>
            <div className='absolute inset-0 z-10'>
                ...
                <div className='transform hover:scale-105 ease-in-out duration-300'>
                    <img alt='take picture' loading='lazy' width='60' height='60' decoding='async' data-nimg='1' className='w-16 h-16 cursor-pointer' src='/capture.png' style={{color: 'transparent'}}/>
                </div>
                </div>
            ...
            <div className='absolute md:bottom-8 bottom-60 left-8 z-20'>
                ...
                <div className='group hidden sm:flex flex-row relative justify-center items-center'>
                    ...
                    <span className='absolute left-[15px] bottom-[13px] scale-[0.9] rotate-180 hidden sm:block text-[#FCFCFC] group-hover:scale-[0.92] ease duration-300'><svg 
    viewBox="0 0 24 24" 
    fill="currentColor" 
